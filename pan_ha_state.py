...
def display_ha_state():
    ...
    if ha_states:
        ...
        column_config = {
            ...
            panorama_instances[0].upper(): st.column_config.TextColumn(panorama_instances[0], width=200),
            panorama_instances[1].upper(): st.column_config.TextColumn(panorama_instances[1], width=200)
        }
